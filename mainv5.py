...
'''
# global variable for bullet spawn offset (to center the spawn location on the center of the player sprite) dividing by 3.6
...
class alien:
    ...
    speed = -math.pow(level, 2) * 1.5 # speed of aliens will scale on level (speed will be the level to the power of 2 times 1.5) note that this starts negative
